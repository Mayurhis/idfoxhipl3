...
class KycDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('kyc_status', function($record) {
                return $record['kyc_status'] ? '<a href="tel:'.$record['kyc_status'].'" title="'.$record['kyc_status'].'">'.$record['kyc_status'].'</a>' : __('global.N/A');
            })  
            ...
            ->rawColumns(['action','email','mobile_number','kyc_status','status','fullAddress','photo_id_image','address_proof_image','liveliness_image', 'photo_upload_option','address_upload_option']);
    }
    ...
    public function query()
    {
        ...
        $apiData = $this->getRequest($url)["data"];
        //dd($apiData);
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('kyc_status')->title(__('cruds.customer.fields.kyc_status')),
            Column::make('status')->title(__('cruds.customer.fields.status')),
