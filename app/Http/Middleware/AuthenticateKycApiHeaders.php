...
class AuthenticateKycApiHeaders
{
    /**
    ...
    {    
        $authKey = $request->header('Authorization-Token');
    ...
    */
    ...
    {   
        return $contentType === config("api.kyc.headers.content_type") &&  $acceptType ===  config("api.kyc.headers.accept");
    }
