                ...
                <div class="user_content">
                    ...
                    <div class="mb-3">
                        <div class="name">
                            ...
                            <span>{{$customerData['brand']['title'] }} </span>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="name">
                            <h4>{{__('cruds.customer.fields.dob')}}</h4>
                            <span>{{date('d F, Y',strtotime($customerData['dob']))}}</span>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="name">
                    ...
                    <div class="mb-3">
                        <div class="name">
                            ...
                            <span>{{$customerData['mobile_number'] ?? __('global.N/A')}}</span>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="name">
                    ...
                    <div class="mb-3">
                        <div class="name">
                            ...
                            <span>{{config('admin.gender')[$customerData['gender']] ?? __('global.N/A')}}</span>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="name">
