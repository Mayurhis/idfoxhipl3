	...
	<div class="row">
		<div class="col-12 col-xl-3  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="prefix" id="prefix" placeholder="{{__('cruds.customer.fields.prefix_placeholder')}}" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 ]/g, '').replace(/(\..*)\./g, '$1');">
				@error('prefix')
		...
		<div class="col-12 col-xl-3  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="first_name" id="first_name" placeholder="{{__('cruds.customer.fields.first_name_placeholder')}}" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 ]/g, '').replace(/(\..*)\./g, '$1');">
				@error('first_name')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-3  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="middle_name" id="middle_name" placeholder="{{__('cruds.customer.fields.middle_name_placeholder')}}" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 ]/g, '').replace(/(\..*)\./g, '$1');">
				@error('middle_name')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-3  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="last_name" id="last_name" placeholder="{{__('cruds.customer.fields.last_name_placeholder')}}" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 ]/g, '').replace(/(\..*)\./g, '$1');">
				@error('last_name')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-3 col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="suffix" id="suffix" placeholder="{{__('cruds.customer.fields.suffix_placeholder')}}" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 ]/g, '').replace(/(\..*)\./g, '$1');">
				@error('suffix')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-3  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<div class="dob-fields ms-0">
					<input type="text" name="dob" id="dob" placeholder="{{__('cruds.customer.fields.dob_placeholder')}}" autocomplete="off" readonly>
		...
		<div class="col-12 col-xl-3  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="email" name="email" id="email" placeholder="{{__('cruds.customer.fields.email')}}">
				@error('email')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-3  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="mobile_number" id="mobile_number" placeholder="{{__('cruds.customer.fields.mobile-sms')}}" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
				@error('mobile_number')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-12  col-lg-12 col-md-12 col-sm-12">
			<div class="form-group">
			    ...
			    <div class="check-list">
		            ...
		            <input class="form-check-input" type="radio" name="gender"  value="{{$key}}" id="flexCheckDefault9"  {{ (isset($customerGender) && $key == 'male' ? 'checked' : '') }} >
		...
		<div class="col-12 col-xl-4 col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="address_line_1" id="address_line_1" placeholder="{{__('cruds.customer.fields.address_line_1')}}">
		...
		<div class="col-12 col-xl-4  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="address_line_2" id="address_line_2" placeholder="{{__('cruds.customer.fields.address_line_2')}}">
		...
		<div class="col-12 col-xl-4  col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="post_code" id="post_code" placeholder="{{__('cruds.customer.fields.post_code')}}" oninput="this.value = this.value.replace(/[^a-zA-Z0-9 ]/g, '').replace(/(\..*)\./g, '$1');">
				@error('post_code')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-4 col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="city" id="city" placeholder="{{__('cruds.customer.fields.city')}}">
				@error('city')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-4 col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields">
				...
				<input type="text" name="region" id="region" placeholder="{{__('cruds.customer.fields.region')}}">
				@error('region')
				<br /><br /><span class="text-danger">{{ $message }}</span>
				@enderror
			</div>
		...
		<div class="col-12 col-xl-4 col-lg-4 col-md-6 col-sm-6">
			<div class="form-group detail-fields select-box-wrap">
				...
				<select class="niceCountryInputSelector from_code2 form-control" id="countryDropDown" name="country_id">
					...
					<option value="{{$countriesList['id']}}" data-src="{{asset('assets/admin/images/flags')}}/{{$countriesList['flag']}}">
