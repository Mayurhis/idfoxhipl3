...
@section('content')
	...
	<div class="main-title add_brand_wrapper">
		<div class="dash-title">
			<h2>{{__('global.edit')}} {{__('cruds.upload-options.title')}}</h2>
		</div>
		<div class="add_brand">
				...
				<div class="kyc-configurator-form">
					...
					<div class="content-form">
						<div class="kyc-form createuser-form">
							<form id="uploadOptionForm" class="upload-option-detail-form" enctype="multipart/form-data" method="POST" action="{{ route('admin.upload-options.update',$uploadOption['uploadOptions']['id'])}}">
								@csrf
