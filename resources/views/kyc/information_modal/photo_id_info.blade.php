							...
							<div class="row">
								<div class="col-12">
									<div class="modal-body text-center">
										<p>Any internationally recognised government ID document will work:</p>
										<p class="line-height13"><strong>National ID Card</strong><br><strong>Passport ID Page</strong><br><strong>Residence Permit</strong><br><strong>Driving License</strong></p>
										<p><strong>Photo Tips:</strong></p>
										<ul class="modal-list mb-3">
											<li>Lay our ID on a flat surface, or hold it up</li>
											<li>Move the camera over your ID and align with the <strong>guide-lines</strong> in the camera frame</li>
