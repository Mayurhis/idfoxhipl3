<div class="modal fade" id="livenessPic" tabindex="-1" aria-hidden="true">
							...
							<div class="row">
								<div class="col-12">
									<div class="modal-body text-center">
										<p><strong>Picture does NOT need to be perfect!<br>#NO FILTER</strong></p>
										<p>Your liveness picture is private. It is only used to verify your identity on your ID document</p>
										<p><strong>Photo tips:</strong></p>
										<ul class="modal-list mb-3">
											<li>Align yourself with the <strong>guide-lines</strong> in the camera frame</li>
											<li>Look straight into the camera</li>
											<li>Do not smile. Serious face ;-)</li>
										</ul>
										<p>If you are not happy, easily re-take your photo</p>
