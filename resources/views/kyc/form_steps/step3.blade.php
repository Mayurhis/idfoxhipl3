<div class="tab-pane fade">
								...
								<div class="liveness_pic">
									<h5 class="text-center size-18 pb-3">{{__('cruds.customer-front-form.face_pic')}}:</h5>
									<div class="photo-idslide width-autoarea position-relative">
										<div class="">
											<div class="item">
												<img src="{{asset('assets/kyc/images/liveness-pic.png')}}" class="d-block w-100" alt="slide-image">
											</div>
										</div>
										<div class="id-info">
											<div class="info-left">
												<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#livenessPic"><svg xmlns="http://www.w3.org/2000/svg" width="492" height="492" viewBox="0 0 492 492" fill="none">
													...
													<div class="row">
														<div class="col-12">
															<div class="modal-header p-0 border-0">
																...
																<h5>{{__('cruds.customer-front-form.upload_face_pic')}}</h5>
													...
													<div class="row">
														<div class="col-12">
															<div class="modal-body text-center">
																<p><strong>{{__('cruds.customer-front-form.upload_face_pic')}}</strong></p>
																...
																<div class="multi-btn mt-5 pt-2">
																	...
																	<a href="javascript:void(0)" class="nbtn  submit-form-3" id="upload_submit2">{{__('global.upload')}}
