{{-- Step 2 --}}
							<div class="tab-pane fade">
								...
								<form class="fileForm customer-detail-form" id="kycVerifiactionStep2" action="{{ route('kyc.storeStep2')}}">
								<div class="photo_id">
									<h5 class="text-center size-18">{{__('cruds.customer-front-form.any_photograph')}}:</h5>
									<ul class="photo-fields" id="photoUplaodOptions">
										
									</ul>

									<div class="photo-idslide position-relative">
										<div class="swiper">
											<div class="swiper-wrapper">
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide1.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide2.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide3.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide4.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide5.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide6.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide7.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide8.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide9.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide10.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide11.png')}}" class="" alt="slide-image">
												</div>
												<div class="swiper-slide">
													<img src="{{asset('assets/kyc/images/slide12.png')}}" class="" alt="slide-image">
												</div>
											</div>
											<div class="swiper-pagination"></div>
										</div>
										<div class="external-pagination"></div>
										<div class="id-info">
											<div class="info-left">
												<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#photoID"><svg xmlns="http://www.w3.org/2000/svg" width="492" height="492" viewBox="0 0 492 492" fill="none">
											...
											<div class="info-right">
												<em># {{__('cruds.customer-front-form.any_clear_photo')}}</em>
											</div>
										</div>
									</div>
									<div class="multi-btn">
										<!-- <a href="javascript:void(0)" class="bgray-btn" data-bs-toggle="modal" data-bs-target="#switchmobile">Switch to mobile<svg xmlns="http://www.w3.org/2000/svg" width="77" height="134" viewBox="0 0 77 134" fill="none" style="height: 28px;">
										...
										<a href="javascript:void(0)" class="nbtn" id="form2Continue">{{__('cruds.customer-front-form.continue')}}</a>
									</div>
								</div>
								<!-- Upload Id Pic -->
								<div class="modal fade upload-pics" id="uploadidPic" tabindex="-1" aria-hidden="true">
													...
													<div class="row">
														<div class="col-12">
															<div class="modal-header p-0 border-0">
																<button type="button" id="stepBack2" class="outline-btn" data-bs-dismiss="modal"><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
																...
																<h5>{{__('cruds.customer-front-form.upload_id_pic')}}</h5>
													...
													<div class="row">
														<div class="col-12">
															<div class="modal-body text-center">
																<p><strong>{{__('cruds.customer-front-form.no_camera_access')}}</strong></p>
																<p>{{__('cruds.customer-front-form.we_highly_recommend')}} <u>{{__('cruds.customer-front-form.switching_devices')}}</u> {{__('cruds.customer-front-form.successfull_id_verification')}}</p>
																<p class="line-height13"><strong>{{__('cruds.customer-front-form.upload_photo_from_device')}}</strong></p>
																...
																<div class="multi-btn mt-5 pt-2">
																	...
																	<a href="javascript:void(0)" class="nbtn  submit-form-2" id="upload_submit">{{__('global.upload')}} 
